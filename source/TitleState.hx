...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		CoolUtil.precacheSound('dootsound','preload');
		...
		logoSpr = new FlxSprite(0, FlxG.height * 0.4);
		logoSpr.frames = Paths.getSparrowAtlas('menucharacters/Menu_Skeletal');
		logoSpr.animation.addByPrefix('funny','menuidle', 48, false);
		add(logoSpr);
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			switch (curBeat)
			{
				...
				case 7:
					addMoreText('This guy right below lol', -60);
					logoSpr.visible = true;
					logoSpr.animation.play('funny',true);
					FlxG.sound.play(Paths.sound('dootsound','preload'), 0.3);
				// credTextShit.text += '\nNewgrounds';
				case 8:
					deleteCoolText();
					logoSpr.visible = false;
				...
				// credTextShit.screenCenter();
				case 13:
					addMoreText('SKELETON');
					FlxG.sound.play(Paths.sound('dootsound','preload'), 0.4);
				// credTextShit.visible = true;
				case 14:
					addMoreText('TRUMPET');
					FlxG.sound.play(Paths.sound('dootsound','preload'), 0.4);
